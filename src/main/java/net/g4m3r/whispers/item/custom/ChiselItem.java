package net.g4m3r.whispers.item.custom;
...
public class ChiselItem extends Item {
    ...
    private static final Map<Block, Block> CHISEL_MAP =
            Map.of(
                ...
                Blocks.BIRCH_LOG, Blocks.MUD,
                 Blocks.NETHERITE_BLOCK, Blocks.GRASS_BLOCK
            );
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("tooltip.whispers.chisel.shift_down"));
        } else {
            tooltip.add(Text.translatable("tooltip.whispers.chisel"));
        }
